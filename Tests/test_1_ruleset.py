...
class Tests:
    def test_hash(self):
        test_ruleset_a = ruleset.RuleSet("Domain",
                                         [rule.Rule("DomainSuffix", "example.com", "TEST")])
        test_ruleset_b = ruleset.RuleSet("Domain",
                                         [rule.Rule("DomainFull", "example.com", "TEST2")])
        test_dict = [ruleset.RuleSet("Domain",
                                     [rule.Rule("DomainSuffix", "example.com", "TEST")])]
    ...
    def test_eq(self):
        ...
        test_ruleset_b = ruleset.RuleSet("Domain",
                                         [rule.Rule("DomainSuffix", "example.com", "TEST")])
        test_ruleset_c = ruleset.RuleSet("Domain",
    ...
    def test_len(self):
        ...
        test_ruleset = ruleset.RuleSet("Domain", test_payload)
    ...
    def test_or(self):
        ...
        test_ruleset_a = ruleset.RuleSet("Domain", [test_rule_a, test_rule_b])
        test_ruleset_b = ruleset.RuleSet("Domain", [test_rule_b, test_rule_c])
        test_ruleset_expected = ruleset.RuleSet("Domain", [test_rule_a, test_rule_b, test_rule_c])
        assert test_ruleset_a | test_ruleset_b == test_ruleset_expected

    def test_contains(self):
        test_rule_a = rule.Rule("DomainSuffix", "a.example.com", "TEST1")
        test_rule_b = rule.Rule("DomainSuffix", "b.example.com", "TEST2")
        test_ruleset = ruleset.RuleSet("Domain", [test_rule_a])
    ...
    def test_copy(self):
        test_ruleset = ruleset.RuleSet("Domain",
    ...
    def test_add(self):
        ...
        assert test_ruleset == ruleset.RuleSet("Domain", [test_rule])

    def test_remove(self):
        test_rule_a = rule.Rule("DomainSuffix", "a.example.com", "TEST1")
        test_rule_b = rule.Rule("DomainSuffix", "b.example.com", "TEST2")
        test_ruleset = ruleset.RuleSet("Domain", [test_rule_a, test_rule_b])
        test_ruleset.remove(test_rule_b)
        assert test_ruleset == ruleset.RuleSet("Domain", [test_rule_a])

    def test_sort(self):
        test_rule_a = rule.Rule("DomainSuffix", "a.example.com", "TEST1")
        test_rule_b = rule.Rule("DomainSuffix", "b.example.com", "TEST2")
        test_ruleset = ruleset.RuleSet("Domain", [test_rule_b, test_rule_a])
        test_ruleset.sort()
        assert test_ruleset == ruleset.RuleSet("Domain", [test_rule_a, test_rule_b])
    ...
    def test_dedup(self):
        ...
        test_ruleset.dedup()
        assert test_ruleset == ruleset.RuleSet("Domain", [test_rule_a, test_rule_d])
